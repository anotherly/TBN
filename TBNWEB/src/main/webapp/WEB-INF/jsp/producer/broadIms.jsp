			...
			<div id="bodyWrap">
				...
				<div id="contentWrap" style="width:1400px;">
					...
					<div id="contents">
						<!-- 탭영역 -->
						<h1>
					    	<img src="../images/ims_word.png" alt="유고정보" onclick="getImsPopUp()" style="width:150px;transform:translate(-5px, 27px);" />
					   	<!-- <img src="../images/tit_02menu03_no.gif" alt="CCTV"  onclick="goTab('divCCTVList');" /> -->
					   	</h1>
...
<!-- 			<button id="btn_refreshIms" onclick="location.href='/producer/broadIms.do'">새로고침</button>
 -->			<img src="../images/refresh2.png" onclick="location.href='/producer/broadIms.do'" style="cursor:pointer;width:80px;" />
             	<!-- <div>
		...
		<!-- 방송리스트 header 끝 -->
		<!-- 검색결과 시작 -->
		<div id="TodayList" class="list_result_sc9" style="border-bottom:1px solid #b7b7b7; height:600px;">
			<div>
				<ul id="broadcastList">
