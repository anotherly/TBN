...
function goStats(url){
    ...
    <div id="contentWrap">
        <!-- <div id="posi"><img src="../images/ico_home.gif" alt="home" />통계관리 > 전국통계</div> -->
        <!-- contents -->
                <div id="contents">
                    <h1 class="txt_i10"><img src="../images/ad_h1_0503.gif" alt="전국통계" /></h1>
                    <!-- board_list -->
                        ...
                        <div class="admin_result_sc">
                            <table border="0" cellpadding="0" cellspacing="0" class="list01">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <!-- roof -->
                                        <td class="txt_left"><img src="../images/ico_excel.gif" alt="" class="mglsub03" /><a href="javascript:goStats('stats/otherReceiptUse.do');">타국 접수정보 활용실적</a></td>
                                        <td><a href="javascript:goStats('stats/otherReceiptUse.do');"><img src="../images/btn_excel_down.gif" alt="엑셀다운로드" /></a></td>
                                    </tr>
                                    <tr>
                                        <!-- roof -->
                                        <td class="txt_left"><img src="../images/ico_excel.gif" alt="" class="mglsub03" /><a href="javascript:goStats('stats/otherReceiptCollect.do');">타국 접수정보 수집실적</a></td>
                                        <td><a href="javascript:goStats('stats/otherReceiptCollect.do');"><img src="../images/btn_excel_down.gif" alt="엑셀다운로드" /></a></td>
                                    </tr>
                                    <tr>
                                        <!-- roof -->
                                        <td class="txt_left"><img src="../images/ico_excel.gif" alt="" class="mglsub03" /><a href="javascript:goStats('stats/otherReceiptBroad.do');">타국 접수정보 방송실적</a></td>
                                        <td><a href="javascript:goStats('stats/otherReceiptBroad.do');"><img src="../images/btn_excel_down.gif" alt="엑셀다운로드" /></a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
