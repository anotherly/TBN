...
<div id="contentWrap">
	<form id="searchFrm" name="searchFrm">
		<div id="searchDiv">
			<div id="contents">
				<h1 class='content-title'>총 마일리지 조회</h1>
				<!-- board_list -->
				<div class="board_list">
					...
					<div class="gnb_tab">
						<ul class="lst_tab">
							...
							<li class="ns"></li>
							<li class="on"><a href="javascript:changePage('allMile')">총 마일리지 조회</a></li>
							<li class="ns"></li>
							<li><a href="javascript:changePage('grade')">등급 조회</a></li>
						</ul>
					</div>
					<div style="position: absolute;right: 0px;top: 52px;">
<%-- 				       <select id="areaOptSel" name="areaCode">
