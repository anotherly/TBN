...
<div id="db_layer11">
    ...
    <div class="tit11_1 scroll">
        ...
        <c:forEach var="list" items="${reportType1}" step="1" varStatus="records">
        	<li id="liTypeCode_${list.ifmId1}">
        		<input type="checkbox" id="chkTypeCode1" name="chkTypeCode1" value="${list.ifmId1}" />
        		<span onclick="getTypeCode('${list.ifmId1}','2', $(this),'${list.ifmId1}')" ondblclick="modTypeCode('${list.ifmId1}','${list.ifmName}','1',$(this))" style="cursor: pointer;">
        			${list.ifmName}
        		</span>
        	</li>
        </c:forEach>
